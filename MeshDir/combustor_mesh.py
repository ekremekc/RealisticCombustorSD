...
# FLAME BOTTOM IS NEGLECTED
gmsh.model.addPhysicalGroup(face_dim, [mass1[-3][1][1]], flame_base_mark) # BOTTOM OF FLAME TAG 8

# REFINEMENT IN FLAME LOCATIONS

lc = 0.030 # Default 0.025

gmsh.model.mesh.field.add("Box", 6)
gmsh.model.mesh.field.setNumber(6, "VIn", lc / 3) # default lc / 6
gmsh.model.mesh.field.setNumber(6, "VOut", lc)
gmsh.model.mesh.field.setNumber(6, "XMin", -0.38)
gmsh.model.mesh.field.setNumber(6, "XMax", 0.38)
gmsh.model.mesh.field.setNumber(6, "YMin", -0.38)
gmsh.model.mesh.field.setNumber(6, "YMax", 0.38)
gmsh.model.mesh.field.setNumber(6, "ZMin", -0.06)
gmsh.model.mesh.field.setNumber(6, "ZMax", +0.20)
gmsh.model.mesh.field.setNumber(6, "Thickness", 0.002)
...
from helmholtz_x.geometry_pkgx.xdmf_utils import  write_xdmf_mesh, XDMFReader
from mpi4py import MPI
write_xdmf_mesh(dir_path +"/"+filename,dimension=3)

combustor = XDMFReader("combustor")
